...
<div id="wrapper">
	...
	<div id="topnavi">
		<div class="spacing1">
			<ul>
				...
				<li><a href="purchasedelete.jsp">Delete Record</a></li>
				<li><a href="#">Modify Records</a></li>
				<li><<a href="purchaseview.jsp">View Records</a></li>
	...
	<div id="bodybox">
		<div id="subnavi">
			...
			<li><a  class="selected" href="medical-details.jsp">Medical Details**</a></li>
		...
		<div id="content">
			...
			<div class="imgbox">
				<img src="img/bg-home.jpg" height="150" width="150" alt="me" />
				<br />
				<p>